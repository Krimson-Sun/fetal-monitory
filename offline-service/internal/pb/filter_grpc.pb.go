...
const (
	FilterService_FilterData_FullMethodName = "/filter.FilterService/FilterData"
)
...
type FilterServiceClient interface {
	FilterData(ctx context.Context, in *FilterRequest, opts ...grpc.CallOption) (*FilterResponse, error)
}
...
func (c *filterServiceClient) FilterData(ctx context.Context, in *FilterRequest, opts ...grpc.CallOption) (*FilterResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FilterResponse)
	err := c.cc.Invoke(ctx, FilterService_FilterData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FilterServiceServer interface {
	FilterData(context.Context, *FilterRequest) (*FilterResponse, error)
...
func (UnimplementedFilterServiceServer) FilterData(context.Context, *FilterRequest) (*FilterResponse, error) {
...
func _FilterService_FilterData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FilterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FilterServiceServer).FilterData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FilterService_FilterData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FilterServiceServer).FilterData(ctx, req.(*FilterRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _FilterService_FilterData_Handler,
		},
	},
